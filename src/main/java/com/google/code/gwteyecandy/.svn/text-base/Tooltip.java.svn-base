...
import static com.google.code.gwteyecandy.Tooltip.TooltipPosition.CURSOR;
...
import com.google.code.gwteyecandy.resources.TooltipResources;
...
public class Tooltip implements DynamicTooltip {
	...
	private final Map<Widget, List<HandlerRegistration>> widgetHandlerRegistrations =
		new IdentityHashMap<Widget, List<HandlerRegistration>>();
	...
	private TooltipPosition position = CURSOR;
